...
from .views import raw_chart_basic, raw_chart_weekwise, raw_chart_monthwise, simple_chart_weekwise_diff, simple_chart_summer_analysis, get_aggregate_analysis_weekly
